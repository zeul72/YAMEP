namespace YAMEP {
    ...
    public abstract class IdentifierASTNode : ASTNode {
        ...
        public IdentifierASTNode( Token token, string name ) : base( token ) => Name = name;
    }


    public class VariableIdentifierASTNode : IdentifierASTNode {
        public VariableIdentifierASTNode( Token token, string name ) 
            : base( token, name ) { }
    }
    ...
    public abstract class UnaryOperatorASTNode : ASTNode {
        ...
        public UnaryOperatorASTNode( Token token, ASTNode target )
    ...
    public class ExponentBinaryOperatorASTNode : BinaryOperatorASTNode {
        public ExponentBinaryOperatorASTNode( Token token, ASTNode left, ASTNode right )
